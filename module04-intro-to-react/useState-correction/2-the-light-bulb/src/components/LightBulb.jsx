// LightBulb component to display the light bulb
const LightBulb = ({ lightOn }) => {
  // Conditionally render the container class based on the lightOn prop
  // If lightOn is true, add the "night" class to the container
  return (
